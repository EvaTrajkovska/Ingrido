...
urlpatterns = [
                ...
                path('meal_successfully_added/<int:menu_id>/', meal_successfully_added, name='mealSuccessfullyAdded'),
                path('meal_successfully_edited/<int:menu_id>/', meal_successfully_edited, name='mealSuccessfullyEdited'),
